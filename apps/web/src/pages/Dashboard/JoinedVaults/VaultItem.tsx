...
import { VaultMigrator } from "web/src/components/VaultMigrator/VaultMigrator";
	...
	return (
		...
		>
			...
			<div className="flex justify-between align-top gap-2">
				...
				<div className="flex flex-col gap-2 font-league-spartan text-lg">
					<div className="flex items-center relative">
						{vault.alt1 ? <img className="w-9 h-9 rounded-full" alt={vault.alt1} src={vault.logo1} /> : null}

						{vault.alt2 ? <img className="w-9 h-9 rounded-full -ml-3" alt={vault.alt2} src={vault.logo2} /> : null}

						{vault.alt3 ? <img className="w-9 h-9 rounded-full -ml-3" alt={vault.alt3} src={vault.logo3} /> : null}
					</div>
			...
			<div className={`grid ${estimateTrax && Number(estimateTrax) > 0 ? "grid-cols-3" : "grid-cols-2"}`}>
				...
				{/* APY */}
				<div className={`text-textSecondary text-sm ml-4 ${estimateTrax && Number(estimateTrax) > 0 ? "border-r border-bgPrimary" : ""}`}>
