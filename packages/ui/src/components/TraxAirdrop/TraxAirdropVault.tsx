...
import { withdrawAirdrop, claimAirdropRewards, fetchAirdropData } from "@beratrax/core/src/state/account/accountReducer";
...
export const TraxAirdropVault = () => {
	...
	const gradientId = useMemo(() => `traxAirdropGrad-${Math.random().toString(36).substr(2, 9)}`, []);
	...
	return (
		...
		>
			...
			<View className="flex flex-row justify-between align-top gap-2 mb-6">
				<View className="flex flex-col gap-2 font-league-spartan text-lg">
					...
					<View className="flex items-center gap-2">
						<Text className="text-lg text-textWhite">TRAX 1st Airdrop Vault</Text>
					</View>
				</View>
				<View className="flex-col gap-1">
					<View className="flex items-center gap-1 mb-2 justify-end">
						...
						<View className="flex">
							<Image alt="Beratrax" className="w-4 rounded-full border border-bgDark" source={{ uri: "beratrax.png" }} />
						</View>
					</View>
				</View>
			</View>
			...
			<View className="flex flex-row justify-between items-center">
				...
				<View className="inline-flex flex-row items-end gap-2 bg-white/5 backdrop-blur-sm rounded-lg p-3">
					<View className="uppercase font-arame-mono text-textPrimary text-md">
						<Text className="text-textPrimary text-md font-arame-mono uppercase">Your Stake</Text>
					</View>
					<View className="text-textWhite text-md font-league-spartan">
