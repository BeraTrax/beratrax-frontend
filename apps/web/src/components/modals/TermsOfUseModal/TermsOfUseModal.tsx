                ...
                >
                    <div className="overflow-y-auto h-[60vh] pr-2 pt-4 text-justify normal-case text-sm font-league-spartan">
                        <p>
                            ...
                            personally or on behalf of an entity ("you") and Beratrax Operations IBC, doing business as
                            BeraTrax ("BeraTrax", "we", "us", or "our"), concerning your access to and use of the
                            http://www.BeraTrax.com website as well as any other media form, media channel, mobile
                            website or mobile application related, linked, or otherwise connected thereto (collectively,
                            the "Site"). You agree that by accessing the Site, you have read, understood, and agreed to
                            be bound by all of these Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE,
                            ...
                            compliance with local laws, if and to the extent local laws are applicable. The Site is not
                            tailored to comply with industry-specific regulations (Health Insurance Portability and
                            Accountability Act (HIPAA), Federal Information Security Management Act (FISMA), etc.), so
                            if your interactions would be subjected to such laws, you may not use this Site. You may not
                            ...
                            at any point during the operation of the services provided. Users of BeraTrax are solely
                            responsible for managing their assets, including the safeguarding of private keys associated
                            with their wallets. BeraTrax facilitates interactions between users and blockchain-based
                            smart contracts without intermediation in the transfer or management of assets.All
                            fiat-to-crypto transactions facilitated through BeraTrax occur via registered and licensed
                            third-party purchasing gateways. These gateways are independently operated and do not deal
                            directly with BeraTrax's wallets or infrastructure. BeraTrax does not have the ability to
                            redirect, manage, or access funds transferred through these gateways. The integration of
                            these third-party services is designed to provide users with a seamless experience in
                            acquiring cryptocurrencies for use within the BeraTrax platform, adhering to the highest
                            standards of regulatory compliance and user security. BeraTrax facilitates user interaction
                            with decentralized applications (dApps) and smart contracts across blockchain networks.
                            While BeraTrax interfaces with smart contracts developed and deployed by third parties, it
                            is critical to understand that BeraTrax itself also deploys smart contracts to support its
                            platform functionalities. These smart contracts are designed to operate within the
                            decentralized framework of blockchain technology, ensuring that BeraTrax does not retain
                            ownership, control, or the capacity to modify these contracts post-deployment. By utilizing
                            BeraTrax, users recognize and embrace the platform's noncustodial nature, acknowledging the
                            intermediary role of third-party gateways for asset acquisition and the operational
                            boundaries of BeraTrax's blockchain-based interactions. Users accept full responsibility for
                            the safeguarding of their assets, affirming that BeraTrax serves merely as a gateway to
                            streamline and enhance the user experience within the DeFi ecosystem. Additionally, BeraTrax
                            may endorse the deployment of auxiliary smart contracts by contributors to augment platform
                            services. Notwithstanding, these contracts are designed to preclude any individual or
                            ...
                            BeraTrax may facilitate interactions with smart contracts that assess a fee based on
                            earnings generated through these contracts. It is essential to understand that such fees are
                            derived solely from the earnings accrued within the smart contracts and at no point involve
                            direct access to, management of, or control over the user's principal funds. These fees are
                            automatically computed and applied by the smart contracts in accordance with predefined
                            terms, ensuring transparency and user awareness. By using BeraTrax, users agree to this fee
                            structure, acknowledging that these fees are a condition of utilizing certain
                            functionalities within the platform. This fee mechanism does not constitute money
                            transmission, as BeraTrax does not handle, possess, or transfer user funds directly. Users
                            retain full control and ownership of their assets at all times, with fees only applicable to
                            the earnings as specified by the contract terms. The fees are subject to change as
                            determined by BeraTrax. The latest fees can be found in our user guide under our
                            disclaimers, here. See the service fee section.
                            <br />
                            <br />
                            <p className="font-bold pt-2">INTELLECTUAL PROPERTY RIGHTS</p> Unless otherwise indicated,
                            ...
                            competition laws of the Panama, international copyright laws, and international conventions.
                            ...
                            permission. Provided that you are eligible to use the Site, you are granted a limited
                            license to access and use the Site and to download or print a copy of any portion of the
                            ...
                            the Marks. <br />
                            <br />
                            <p className="font-bold pt-2">USER REPRESENTATIONS</p> By using the Site, you represent and
                            warrant that:
                            <br />
                            <br />
                            ...
                            <br />
                            <br />
                            (4) you will not use the Site for any illegal or unauthorized purpose; and (5) your use of
                            the Site will not violate any applicable law or regulation. If you provide any information
                            ...
                            portion thereof). <br />
                            <br />
                            <p className="font-bold pt-2">PROHIBITED ACTIVITIES</p> You may not access or use the Site
                            for any purpose other than that for which we make the Site available. The Site may not be
                            used in connection with any commercial endeavors except those that are specifically endorsed
                            or approved by us. As a user of the Site, you agree not to: <br />
                            <br />
                            ...
                            limitations on the use of the Site and/or the Content contained therein. <br />
                            <br />
                            ...
                            functions, operation, or maintenance of the Site. <br />
                            <br />
                            ...
                            passive or active information collection or transmission mechanism, including without or
                            ...
                            JavaScript, or other code. <br />
                            <br />
                            20. Decipher, decompile, disassemble, or reverse engineer any of the software comprising or
                            in any way making up a part of the Site. <br />
                            <br />
                            ...
                            addresses of users by electronic or other means for the purpose of sending unsolicited means
                            for the purpose of sending unsolicited email, or creating user accounts by automated means
                            or under false pretenses. <br />
                            <br />
                            23. Use the Site as part of any effort to compete with us or otherwise use the Site and/or
                            the Content for any revenue-generating endeavor or commercial enterprise. <br />
                            <br />
                            ...
                            proprietary infringe the proprietary rights, including but not limited to the copyright,
                            patent, trademark, trade secret or moral rights of any third party. <br />
                            <br />
                            ...
                            or exploits people under the age of 18 in a sexual or violent manner. <br />
                            <br />
                            ...
                            provision of these Terms of Use, or any applicable law or regulation. Any use of the Site in
                            violation of the foregoing violates these Terms of Use and may result use of the Site in
                            ...
                            (including settings). By submitting suggestions or other feedback regarding the Site, you
                            ...
                            responsibility and to refrain from any legal action against us regarding your Contribution
                            <br />
                            <br />
                            <p className="font-bold pt-2">APPLICATION LICENSE</p> BeraTrax dApp Use The BeraTrax app is
                            a work in progress and may contain bugs, errors, or other problems that could cause loss of
                            funds or other damages. By using the app, you acknowledge that you are doing so at your own
                            risk, and that Beratrax Operations IBC and the BeraTrax platform bear no responsibility for
                            any losses you may incur. The app is not intended for investment purposes, and Beratrax
                            Operations IBC does not endorse any token listed on the platform. If you choose to invest in
                            any token listed on the platform, you do so at your own risk, and Beratrax Operations IBC
                            and the BeraTrax platform bear no responsibility for any losses you may incur. The features
                            and functionality of the BeraTrax app may change at any time, without notice. Beratrax
                            Operations IBC reserves the right to make changes to the app, including but not limited to
                            adding, removing, or modifying features, at its sole discretion. By using the BeraTrax app,
                            you agree to comply with all applicable laws and regulations. You also agree to not use the
                            app for any illegal or fraudulent activities. Beratrax Operations IBC reserves the right to
                            terminate your access to the BeraTrax app at any time, for any reason, without notice. These
                            terms and conditions are subject to change at any time, without notice. It is your
                            responsibility to check for updates to these terms and conditions. Your continued use of the
                            BeraTrax app after any such updates constitutes your acceptance of the updated terms and
                            conditions. Use License If you access the Site via a mobile application, then we grant you a
                            revocable, nonexclusive, non-transferable, limited right to install and use the mobile
                            ...
                            accessories, or devices for use with the application. Terms and Conditions for Using
                            BeraTrax App By using any of the features on the BeraTrax app, a web-based decentralized app
                            launched by Beratrax Operations IBC, a Panama-based IBC, you agree to the following terms
                            and conditions. Apple and Android Devices The following terms apply when you use a mobile
                            application obtained from either the Apple Store or Google Play (each an “App Distributor”)
                            to access the Site: (1) the license granted to you for our mobile application is limited to
                            a non-transferable license to use the application on a device that utilizes the Apple iOS or
                            Android operating systems, as applicable, and in accordance with the usage rules set forth
                            in the applicable App Distributor’s terms of service; (2) we are responsible for providing
                            any maintenance and support services with respect to the mobile application as specified in
                            the terms and conditions of this mobile application license contained in these Terms of Use
                            or as otherwise required under applicable law, and you acknowledge that each App Distributor
                            has no obligation whatsoever to furnish any maintenance and support services with respect to
                            the mobile application; (3) in the event of any failure of the mobile application to conform
                            ...
                            <br />
                            <br />
                            <p className="font-bold pt-2">SUBMISSIONS</p> You acknowledge and agree that any questions,
                            comments, suggestions, ideas, feedback, or other information regarding the Site
                            ("Submissions") provided by you to us are nonconfidential and shall become our sole
                            ...
                            <br />
                            <br />
                            <p className="font-bold pt-2">THIRD-PARTY WEBSITE AND CONTENT</p> The Site may contain (or
                            you may be sent via the Site) links to other websites ("Third-Party Websites") as well as
                            ...
                            leave the Site and access the Third-Party Websites or to use or install any Third-Party
                            ...
                            harmless from any losses sustained by you or harm caused to you relating to or resulting in
                            ...
                            <br />
                            <br />
                            <p className="font-bold pt-2">PRIVACY POLICY</p> We care about data privacy and security. By
                            using the Site, you agree to be bound by our Privacy Policy posted on the Site, which is
                            incorporated into these Terms of Use. Please be advised the Site is hosted in the Panama. If
                            ...
                            the Panama, then through your continued use of the Site, you are transferring your data to
                            the Panama, and you agree to have your data transferred to and processed in the Panama. TERM
                            AND TERMINATION These Terms of Use shall remain in full force and effect while you use the
                            Site. WITHOUT LIMITING ANY OTHER PROVISION OF THESE TERMS OF USE, WE RESERVE THE RIGHT TO,
                            ...
                            YOUR USE OR PARTICIPATION IN THE SITE OR DELETE ANY CONTENT OR INFORMATION THAT YOU POSTED
                            AT ANY TIME, WITHOUT WARNING, IN OUR SOLE DISCRETION. If we terminate or suspend your
                            ...
                            <br />
                            <br />
                            <p className="font-bold pt-2">MODIFICATIONS AND INTERRUPTIONS</p> We reserve the right to
                            ...
                            Site. We also reserve the right to modify or discontinue all or part of the Site without
                            notice at any time. We will not be liable to you or any third party for any modification,
                            price change, suspension, or discontinuance of the Site. We cannot guarantee the Site will
                            be available at all times. We may experience hardware, software, or other problems or need
                            to perform maintenance related to the Site, resulting in interruptions, delays, or errors.
                            ...
                            any corrections, updates, or releases in connection therewith. <br />
                            <br />
                            <p className="font-bold pt-2">GOVERNING LAW</p> These Terms of Use and your use of the Site
                            are governed by and construed in accordance with the laws of the State of Panama applicable
                            to agreements made and to be entirely performed within the State of Panama, without regard
                            to its conflict of law principles. <br />
                            <br />
                            <p className="font-bold pt-2">DISPUTE RESOLUTION</p> Binding Arbitration If the Parties are
                            unable to resolve a Dispute through informal negotiations, the Dispute (except those
                            ...
                            applicable law, the arbitration will take place in the jurisdiction of Panama. Except as
                            ...
                            located in Wilmington, Panama, and the Parties hereby consent to, and waive all defenses of
                            lack of personal jurisdiction, and forum non conveniens with respect to venue and
                            jurisdiction in such courts. Application of the United Nations Convention on Contracts for
                            ...
                            related in any way to the Site be commenced more than one (1) years after the cause of
                            ...
                            submit to the personal jurisdiction of that court. Restrictions The Parties agree that any
                            arbitration shall be limited to the Dispute between the Parties individually. To the full
                            extent permitted by law, (a) no arbitration shall be joined with any other proceeding; (b)
                            there is no right or authority for any Dispute to be arbitrated on a class-action basis or
                            to utilize class action procedures; and (c) there is no right or authority for any Dispute
                            to be brought in a purported representative capacity on behalf of the general public or any
                            other persons. Exceptions to Arbitration The Parties agree that the following Disputes are
                            not subject to the above provisions concerning binding arbitration: (a) any Disputes seeking
                            ...
                            <br />
                            <p className="font-bold pt-2">CORRECTIONS</p> There may be information on the Site that
                            ...
                            without prior notice. DISCLAIMER THE SITE IS PROVIDED ON AN AS-IS AND AS-AVAILABLE BASIS.
                            YOU AGREE THAT YOUR USE OF THE SITE AND OUR SERVICES WILL BE AT YOUR SOLE RISK. TO THE
                            FULLEST EXTENT PERMITTED BY LAW, WE DISCLAIM ALL WARRANTIES, EXPRESS OR IMPLIED, IN
                            CONNECTION WITH THE SITE AND YOUR USE THEREOF, INCLUDING, WITHOUT LIMITATION, THE IMPLIED
                            ...
                            MADE AVAILABLE VIA THE SITE. WE DO NOT WARRANT, ENDORSE, GUARANTEE, OR ASSUME RESPONSIBILITY
                            ...
                            PURCHASE OF A RODUCT OR SERVICE THROUGH ANY MEDIUM OR IN ANY ENVIRONMENT, YOU SHOULD USE
                            YOUR BEST JUDGMENT AND EXERCISE CAUTION WHERE APPROPRIATE. LIMITATIONS OF LIABILITY IN NO
                            ...
                            RIGHTS. INDEMNIFICATION You agree to defend, indemnify, and hold us harmless, including our
                            ...
                            to this indemnification upon becoming aware of it. <br />
                            <br />
                            <p className="font-bold pt-2">USER DATA</p> We will maintain certain data that you transmit
                            to the Site for the purpose of managing the performance of the Site, as well as data
                            relating to your use of the Site. Although we perform regular routine backups of data, you
                            are solely responsible for all data that you transmit or that relates to any activity you
                            have undertaken using the Site. You agree that we shall have no liability to you for any
                            loss or corruption of any such data, and you hereby waive any right of action against us
                            arising from any such loss or corruption of such data. ELECTRONIC COMMUNICATIONS,
                            TRANSACTIONS, AND SIGNATURES Visiting the Site, sending us emails, and completing online
                            ...
                            by any means other than electronic means. <br />
                            <br />
                            <p className="font-bold pt-2">CALIFORNIA USERS AND RESIDENTS</p> If any complaint with us is
                            not satisfactorily resolved, you can contact the Complaint Assistance Unit of the Division
                            of Consumer Services of the California Department of Consumer Affairs in writing at 1625
                            North Market Blvd., Suite N 112, Sacramento, California 95834 or by telephone at (800)
                            952-5210 or (916) 445-1254. <br />
                            <br />
                            <p className="font-bold pt-2">MISCELLANEOUS</p> These Terms of Use and any policies or
                            ...
                            to execute these Terms of Use. <br />
                            <br />
                            <p className="font-bold pt-2">CONTACT US</p>
                            <br /> In order to resolve a complaint regarding the Site or to receive further information
                            regarding use of the Site, please contact us at: Beratrax Operations IBC. <br />
