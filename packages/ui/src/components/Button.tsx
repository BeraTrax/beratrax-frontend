...
export const Button = ({ variant = "primary", size = "medium", className, title, ...props }: ButtonProps) => {
  ...
  return (
    <Text className={buttonStyles + " " + className + " " + "text-textPrimary bg-bgSecondary "}>
      {title}
    </Text>
  );
};
