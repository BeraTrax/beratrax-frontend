...
export type { TokenActionType } from "@beratrax/core/src/types/airdrop";
	...
	return (
		<View className="w-full p-4">
			{shouldRenderAirdropSection ? (
				...
				>
					<Text className="font-league-spartan font-bold text-3xl mb-6">TRAX Season 1 & 2 Airdrops</Text>
					...
					<View className="flex items-center justify-between mb-2">
						...
						{currentWallet && top20.map((e) => getAddress(e)).includes(getAddress(currentWallet)) && (
							<View className="inline-flex items-center gap-2 px-3 py-1.5 bg-gradient-to-r from-yellow-400 to-orange-500 rounded-full shadow-lg border-2 border-yellow-300/50">
								...
								<Text className="font-league-spartan font-bold text-black text-sm bg-black/20 px-2 py-0.5 rounded-full">3x Multiplier</Text>
							</View>
						)}
					</View>
						...
						<View className="flex flex-col gap-4">
							...
							<View className="flex justify-center">
								<View className="relative">
									...
									>
										<View className="relative z-[1] flex items-center gap-2">
