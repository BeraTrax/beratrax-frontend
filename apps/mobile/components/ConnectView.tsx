		...
		<View style={[styles.container]}>
			...
			<View style={styles.statusContainer}>
				<View
					style={[
						styles.statusDot,
						{
							backgroundColor: status === "connected" ? "#4ade80" : status === "connecting" ? "#facc15" : "#ef4444",
						},
					]}
				/>
			...
			{status === "disconnected" && (
				<View style={styles.debugContainer}>
					<Text style={styles.debugText}>If you're experiencing connection issues, check:</Text>
					<Text style={styles.debugItem}>• Your internet connection</Text>
					<Text style={styles.debugItem}>• WalletConnect projectId is valid</Text>
					<Text style={styles.debugItem}>• Allowed origins in WalletConnect dashboard</Text>
				</View>
			)}
		</View>
	);
