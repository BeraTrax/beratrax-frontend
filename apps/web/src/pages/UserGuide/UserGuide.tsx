	...
	return (
		<div className="overflow-auto">
			<div className="text-xl text-textWhite p-10 flex gap-y-8 flex-col font-light ">
				<h1 className="font-bold text-4xl leading-none uppercase">💰 BeraTrax User Guide: Your Gateway to Seamless DeFi on Berachain</h1>
				<p>
					Welcome to <b>BeraTrax</b>, the easiest way to access{" "}
					<b>yield-earning vaults, auto-compounded rewards, and Berachain’s Proof of Liquidity system—all through your phone.</b>
					Whether you're new to DeFi or a seasoned yield farmer, BeraTrax is built to <b>remove the complexity</b> and help you maximize
					your returns.
				</p>
				...
				<>
					...
					<IconWithHeading Icon={ICONS.check} color="var(--new-gradient-light)">
						<b>Social Login</b> – Sign in instantly using an email, Twitter, or Discord (you own your social wallet, & can export you key)
					</IconWithHeading>

					<IconWithHeading Icon={ICONS.check} color="var(--new-gradient-light)">
						<b>Wallet Connection</b> – Use <b>MetaMask, WalletConnect, or Ledger</b> to connect an existing wallet.
					</IconWithHeading>

					<IconWithHeading Icon={ICONS.diamond} size={14} color="transparent" stroke="var(--new-gradient-light)" strokeWidth={1}>
						<b>First-time users? </b>
						If signing in via social login, BeraTrax will <b>automatically create a wallet</b> for you on Berachain’s mainnet.
					</IconWithHeading>
				...
				<>
					...
					<IconWithHeading Icon={ICONS.diamond} size={14} color="transparent" stroke="var(--new-gradient-light)" strokeWidth={1}>
						<b>BTX Points</b> – Monitor your earned <b>BTX governance points and BGT staking rewards (coming soon).</b>
					</IconWithHeading>
				</>
				...
				<>
					...
					<IconWithHeading Icon={ICONS.check} color="var(--new-gradient-light)">
						<b>Auto-compounding is enabled by default</b> — your rewards are continuously reinvested to maximize yield.
					</IconWithHeading>
					<IconWithHeading Icon={ICONS.check} color="var(--new-gradient-light)">
				...
				<>
					...
					<p>
						BeraTrax <b>automatically optimizes yield</b> using Berachain’s <b>Proof of Liquidity (PoL)</b> mechanism:
					</p>
					<IconWithHeading Icon={ICONS.check} color="var(--new-gradient-light)">
						<b>All vault fees are pooled and used to bribe validators</b>, increasing BGT emissions for staked users.
					</IconWithHeading>
					<IconWithHeading Icon={ICONS.check} color="var(--new-gradient-light)">
						Users can <b>opt-in to auto-convert BGT into iBGT</b>, earning <b>boosted validator rewards</b> without extra steps.
					</IconWithHeading>
					<IconWithHeading Icon={ICONS.check} color="var(--new-gradient-light)">
						<b>iBGT is liquid</b>—users can swap, stake, or hold for further rewards.
					</IconWithHeading>
					<p>
						You don’t need to manually participate in Berachain’s PoL system—BeraTrax <b>does it all for you</b> in the background.
					</p>
				</>
				...
				<>
					...
					<IconWithHeading Icon={ICONS.diamond} size={14} color="transparent" stroke="var(--new-gradient-light)" strokeWidth={1}>
						<b>BTX Points</b>: Earn points for staking in vaults—these points determine your share of the upcoming BeraTrax token airdrop.
					</IconWithHeading>
					<IconWithHeading Icon={ICONS.diamond} size={14} color="transparent" stroke="var(--new-gradient-light)" strokeWidth={1}>
						<b>Referrals</b>: Grab your unique referral link from the Dashboard. Earn the same BTX points as every user you bring into
						BeraTrax!
					</IconWithHeading>
				...
				<>
					...
					<p>
						BeraTrax <b>removes complexity</b>—one-click deposits, gas-free transactions, auto-compounding, and built-in PoL participation
						make it <b>the easiest way to earn yield on Berachain</b>.
					</p>
					<IconWithHeading Icon={ICONS.question} color="transparent" stroke="maroon" strokeWidth={1}>
					...
					<p>
						Your earned rewards can be viewed on the <b>Dashboard</b> and claimed at any time. BeraTrax <b>auto-compounds</b> your rewards
						so that they are continuously reinvested for higher APY. BGT and iBGT earning opportunities are coming soon.
					</p>
					<IconWithHeading Icon={ICONS.question} color="transparent" stroke="maroon" strokeWidth={1}>
						<b>Is BeraTrax safe?</b>
					</IconWithHeading>
					<p>
						Security is a top priority. BeraTrax only utilizes <b>audited smart contracts</b> and Berachain’s <b>native PoL</b> system to
						ensure safe, trustless yield farming. We even protect against any unknown exploits using Spherex’s zero day exploit protection
						on every one of our contracts!
					</p>
				</>
				...
				<>
					...
					<IconWithHeading Icon={GiWorld} color="var(--new-gradient-light)" stroke="var(--new-gradient-light)" strokeWidth={1}>
						<b>Website:</b>{" "}
					...
					<p>
						📢 <b>Twitter:</b>{" "}
						<Link to={"https://twitter.com/BeraTrax"} className="text-textPrimary underline" target="_blank">
							@BeraTrax
						</Link>
					</p>
					<IconWithHeading Icon={BsChat} color="transparent" stroke="var(--new-gradient-light)" strokeWidth={1}>
						<b>Discord:</b>{" "}
