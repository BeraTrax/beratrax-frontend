...
import { FarmOriginName, FarmOriginLogo } from "@beratrax/core/src/state/farms/types";
export interface PoolDef {
	...
	isUpcoming?: boolean;
	secondary_platform?: FarmOriginName;
	secondary_platform_logo?: FarmOriginLogo;
	createdAt?: number;
...
const pools_json: PoolDef[] = [
	{
		...
		name: "LBGT-wBERA",
		url_name: "LBGT-wBERA",
		originPlatform: FarmOriginPlatform.Kodiak.name,
		platform: FarmOriginPlatform.Kodiak.name,
		platform_logo: FarmOriginPlatform.Kodiak.logo,
		secondary_platform_logo: FarmOriginPlatform.Kodiak.logo,
		source:
			"https://app.kodiak.finance/#/liquidity/pools/0x337ef1eb6c8bbed571170fc2b468608ab9e2aac8?farm=0x9d65da133391b2c055509d049c835a821d84e922&chain=berachain_mainnet",
		name1: "LBGT",
		name2: "wBERA",
		description:
			"This vault is built on Kodiak's LBGT-wBERA vault. Your deposit is automatically converted into the LBGT-wBERA LP and deposited for you. You can zap in using HONEY or BERA. Additionally, you'll accumulate BTX points for our future airdrop, and keep any airdrops to any of the underlying vaults. (Note: Although Trax does not have a deposit/withdraw fee, third party slippage applies for zaps. Your actual deposit is in LBGT-wBERA LP, not your starting token before zapping.)",
		stableCoin: false,
		platform_alt: `${FarmOriginPlatform.Kodiak.name} logo`,
		total_apy: 36.477,
		rewards_apy: 0,
		pair1: "LBGT",
		pair2: "wBERA",
		...
		rewards1: FarmOriginPlatform.Kodiak.logo,
		rewards1_alt: `${FarmOriginPlatform.Kodiak.name} logo`,
		isDeprecated: false,
		isUpgradable: false,
		isAutoCompounded: true,
	...
	},
	{
		...
		secondary_platform_logo: FarmOriginPlatform.Kodiak.logo,
		source:
			"https://app.kodiak.finance/#/liquidity/pools/0x7fd165b73775884a38aa8f2b384a53a3ca7400e6?farm=0x34852c863d266100f573d4d1fd1d0cfe20602da0&chain=berachain_mainnet",
		name1: "rUSD",
		name2: "HONEY",
		description:
	...
	},
	{
		...
		secondary_platform_logo: FarmOriginPlatform.Kodiak.logo,
		source:
			"https://app.kodiak.finance/#/liquidity/pools/0x4a254b11810b8ebb63c5468e438fc561cb1bb1da?farm=0x45325df4a6a6ebd268f4693474aaaa1f3f0ce8ca&chain=berachain_mainnet",
		name1: "wBERA",
		name2: "HONEY",
		description:
	...
	},
	{
		...
		secondary_platform_logo: FarmOriginPlatform.Kodiak.logo,
		source:
			"https://app.kodiak.finance/#/liquidity/pools/0xf06ea29fcf4765200742d29e685973a1870eac98?farm=0xeec2ad7bb37374229860265e644f4e2693b23fdd&chain=berachain_mainnet",
		name1: "wBERA",
		name2: "wBTC",
		description:
	...
	},
	{
		...
		secondary_platform_logo: FarmOriginPlatform.Kodiak.logo,
		source:
			"https://app.kodiak.finance/#/liquidity/pools/0x9659dc8c1565e0bd82627267e3b4eed1a377ebe6?farm=0xfb657cd154e661ddf3e229529d92545640b19292&chain=berachain_mainnet",
		name1: "wETH",
		name2: "wBERA",
		description:
	...
	},
	{
		...
		secondary_platform_logo: FarmOriginPlatform.Kodiak.logo,
		source:
			"https://app.kodiak.finance/#/liquidity/pools/0x564f011d557aad1ca09bfc956eb8a17c35d490e0?farm=0x3be1be98efaca8c1eb786cbf38234c84b5052eeb&chain=berachain_mainnet",
		name1: "iBGT",
		name2: "wBERA",
		description:
	...
	},
	{
		...
		secondary_platform_logo: FarmOriginPlatform.Kodiak.logo,
		source:
			"https://app.kodiak.finance/#/liquidity/pools/0x56449b16ff2b1e5ee61f532ceffda8f408f718a1?farm=0xed0fb3170390ef82e13102f36fa7fd5047722890&chain=berachain_mainnet",
		name1: "wBERA",
		name2: "BR",
		description:
	...
	},
	{
		...
		secondary_platform_logo: FarmOriginPlatform.Kodiak.logo,
		source:
			"https://app.kodiak.finance/#/liquidity/pools/0x43e487126c4f37d1915cf02a90b5c5295afb1790?farm=0x3fc5cb0290c82680afe9ef8cdde5468d74c85705&chain=berachain_mainnet",
		name1: "SolvBtc",
		name2: "SolvBTC.BBN",
		description:
	...
	},
	{
		...
		secondary_platform_logo: FarmOriginPlatform.Kodiak.logo,
		source:
			"https://app.kodiak.finance/#/liquidity/pools/0x3879451f4f69f0c2d37cad45319cff2e7d29c596?farm=0x11fadf69a02340a676b4bd2a27ffd952094fae99&chain=berachain_mainnet",
		name1: "wBTC",
		name2: "SolvBTC",
		description:
	...
	},
	{
		...
		secondary_platform_logo: FarmOriginPlatform.Kodiak.logo,
		source:
			"https://app.kodiak.finance/#/liquidity/pools/0xe3eeb9e48934634d8b5b39a0d15dd89ee0f969c4?farm=0xa2c5adb20a446fa71a1762002e3c9b4dd37dbaf4&chain=berachain_mainnet",
		name1: "iBERA",
		name2: "wBERA",
		description:
	...
	},
	{
		...
		secondary_platform_logo: FarmOriginPlatform.Kodiak.logo,
		source:
			"https://app.kodiak.finance/#/liquidity/pools/0xad445256ff81171043a5e7cd8831e4371b000176?farm=0x15f1156f56a06af851cbdc0aceb0780bbcb913c4&chain=berachain_mainnet",
		name1: "iBERA",
		name2: "osBGT",
		description:
	...
	},
	{
		...
		secondary_platform_logo: FarmOriginPlatform.Kodiak.logo,
		source:
			"https://app.kodiak.finance/#/liquidity/pools/0x7cebcc76a2faecc0ae378b340815fcbb71ec1fe0?farm=0xc196d595dece185ea39f8e1c3ce07a274ac31985&chain=berachain_mainnet",
		name1: "sUSDa",
		name2: "USDa",
		description:
	...
	},
	{
		...
		platform: FarmOriginPlatform.Infrared.name,
		platform_logo: FarmOriginPlatform.Infrared.logo,
		...
		stableCoin: false,
		platform_alt: `${FarmOriginPlatform.Infrared.name} logo`,
		total_apy: 36.477,
		rewards_apy: 0,
		pair1: "iBERA",
		...
		rewards1: FarmOriginPlatform.Infrared.logo,
		rewards1_alt: `${FarmOriginPlatform.Infrared.name} logo`,
		isDeprecated: false,
		isUpgradable: false,
	...
	},
	{
		...
		name: "stLBGT",
		url_name: "stLBGT",
		originPlatform: FarmOriginPlatform.BeraPaw.name,
		platform: FarmOriginPlatform.BeraPaw.name,
		platform_logo: FarmOriginPlatform.BeraPaw.logo,
		...
		stableCoin: false,
		platform_alt: `${FarmOriginPlatform.BeraPaw.name} logo`,
		total_apy: 36.477,
		rewards_apy: 0,
		pair1: "stLBGT",
		...
		alt1: "stLBGT logo",
		logo1: "https://raw.githubusercontent.com/BeraTrax/tokens/main/beratrax-tokens/0xBaadCC2962417C01Af99fb2B7C75706B9bd6Babe/logo.png",
		rewards1: FarmOriginPlatform.BeraPaw.logo,
		rewards1_alt: `${FarmOriginPlatform.BeraPaw.name} logo`,
		isDeprecated: false,
		isUpgradable: false,
		isAutoCompounded: false,
	...
	},
	{
		...
		name1: "TRAX",
		description:
			"This vault is built on Trax's TRAX Staking Vault. Your deposit is automatically staked, and all rewards are claimed and auto-compounded every minute. You can deposit directly with TRAX or zap in using HONEY or BERA. (Note: Although Trax does not have a deposit/withdraw fee, third party slippage applies for zaps. Your actual deposit is in TRAX, not your starting token before zapping.) ",
		stableCoin: false,
		platform_alt: `${FarmOriginPlatform.Trax.name} logo`,
		total_apy: 550,
		rewards_apy: 0,
		pair1: "TRAX",
		...
		rewards1: FarmOriginPlatform.Trax.logo,
		rewards1_alt: `${FarmOriginPlatform.Trax.name} logo`,
		isDeprecated: false,
		isUpgradable: false,
		isAutoCompounded: true,
	...
	},
	{
		...
		platform_logo: FarmOriginPlatform.Kodiak.logo,
		source:
			"https://app.kodiak.finance/#/liquidity/pools/0x5347e5133b22a680ee94b7e62803e848f8d8c92e?farm=0xbd3d6db7b600b18252e2d5d21f29c5e61e1e3f05&chain=berachain_mainnet",
		name1: "yBERA",
		name2: "yBGT",
		description:
			"This vault is built on Kodiak's yBERA-yBGT vault. Your deposit is automatically staked, and all rewards are claimed and auto-compounded every minute. You can deposit directly with yBERA-yBGT or zap in using HONEY or BERA. Additionally, you'll accumulate BTX points for our future airdrop, and keep any airdrops to any of the underlying vaults. (Note: Although Trax does not have a deposit/withdraw fee, third party slippage applies for zaps. Your actual deposit is in yBERA-yBGT, not your starting token before zapping.) ",
		stableCoin: false,
		platform_alt: `${FarmOriginPlatform.Kodiak.name} logo`,
		total_apy: 36.477,
		rewards_apy: 0,
		...
		token2: "0x7e768f47dfDD5DAe874Aac233f1Bc5817137E453",
		zapper_addr: "0xF441d25e923beB22e0ADeCefF07d25aF952FB296",
		alt1: "yBERA logo",
		alt2: "yBGT logo",
		logo1: "https://raw.githubusercontent.com/BeraTrax/tokens/main/beratrax-tokens/ybera/logo.png",
		logo2: "https://raw.githubusercontent.com/BeraTrax/tokens/main/beratrax-tokens/ybgt/logo.png",
		rewards1: FarmOriginPlatform.Kodiak.logo,
		rewards1_alt: `${FarmOriginPlatform.Kodiak.name} logo`,
		isDeprecated: false,
		isUpgradable: false,
		isAutoCompounded: true,
		synthetic: true,
		lp_address: "0x5347e5133b22A680Ee94b7e62803E848F8d8C92e", // Asset LP address
		decimals: 18,
		vault_addr: "0xc7C41c8eFEB2A0a2E0Df1F4b52B470e6936e5b58", // Vault address
		createdAt: 1747404574,
		zap_symbol: "HONEY",
		zap_currencies: [
			{
				symbol: "HONEY",
	...
	},
	{
		...
		platform: FarmOriginPlatform.Bearn.name,
		platform_logo: FarmOriginPlatform.Bearn.logo,
		source: "https://bearn.sucks/ybgt",
		name1: "styBGT",
		description:
			"This vault is built on Bearn's styBGT vault. Your deposit is automatically staked, and all rewards are claimed and auto-compounded every minute. You can deposit directly with styBGT or zap in using HONEY or BERA. Additionally, you'll accumulate BTX points for our future airdrop, and keep any airdrops to any of the underlying vaults. (Note: Although Trax does not have a deposit/withdraw fee, third party slippage applies for zaps. Your actual deposit is in styBGT, not your starting token before zapping.) ",
		stableCoin: false,
		platform_alt: `${FarmOriginPlatform.Bearn.name} logo`,
		total_apy: 36.477,
		rewards_apy: 0,
		pair1: "styBGT",
		token1: "0x6f8cEAF347dA79287e49A5C9F0a03b20BDFCB7D3",
		zapper_addr: "0xAc75Dc484AbBa11685299dD397B32497b691c98A",
		alt1: "styBGT logo",
		logo1: "https://raw.githubusercontent.com/BeraTrax/tokens/main/beratrax-tokens/ybgt/logo.png",
		rewards1: FarmOriginPlatform.Bearn.logo,
		rewards1_alt: `${FarmOriginPlatform.Bearn.name} logo`,
		isDeprecated: false,
		isUpgradable: false,
		isAutoCompounded: true,
		lp_address: "0x6f8cEAF347dA79287e49A5C9F0a03b20BDFCB7D3", // Asset LP address
		decimals: 18,
		vault_addr: "0x420F2cc7847D80cd11e9b8aBeDaeFf3909fc3A60", // Vault address
		createdAt: 1747404574,
		zap_symbol: "HONEY",
		zap_currencies: [
			{
	...
	},
	{
		...
		platform: FarmOriginPlatform.Bearn.name,
		platform_logo: FarmOriginPlatform.Bearn.logo,
		source: "https://bearn.sucks/ybera",
		name1: "styBERA",
		description:
			"This vault is built on Bearn's styBERA vault. Your deposit is automatically staked, and all rewards are claimed and auto-compounded every minute. You can deposit directly with styBERA or zap in using HONEY or BERA. Additionally, you'll accumulate BTX points for our future airdrop, and keep any airdrops to any of the underlying vaults. (Note: Although Trax does not have a deposit/withdraw fee, third party slippage applies for zaps. Your actual deposit is in styBERA, not your starting token before zapping.) ",
		stableCoin: false,
		platform_alt: `${FarmOriginPlatform.Bearn.name} logo`,
		total_apy: 36.477,
		rewards_apy: 0,
		pair1: "styBERA",
		token1: "0xCD0A794A2FfF32e21Dc4fE3081909Ad7e4B55a35",
		zapper_addr: "0xAc75Dc484AbBa11685299dD397B32497b691c98A",
		alt1: "styBGT logo",
		logo1: "https://raw.githubusercontent.com/BeraTrax/tokens/main/beratrax-tokens/ybera/logo.png",
		rewards1: FarmOriginPlatform.Bearn.logo,
		...
		isUpgradable: false,
		isAutoCompounded: false,
		lp_address: "0xCD0A794A2FfF32e21Dc4fE3081909Ad7e4B55a35", // Asset LP address
		decimals: 18,
		vault_addr: "0xcB15b3b53c49509d25a079399af9C2d0e2812f2C", // Vault address
		createdAt: 1747404574,
		zap_symbol: "HONEY",
		zap_currencies: [
			{
	...
	},
	{
		...
		platform: FarmOriginPlatform.Bearn.name,
		platform_logo: FarmOriginPlatform.Bearn.logo,
		source: "https://bearn.sucks/yhoney",
		name1: "styHONEY",
		description:
			"This vault is built on Bearn's styHONEY vault. Your deposit is automatically staked, and all rewards are claimed and auto-compounded every minute. You can deposit directly with styHONEY or zap in using HONEY or BERA. Additionally, you'll accumulate BTX points for our future airdrop, and keep any airdrops to any of the underlying vaults. (Note: Although Trax does not have a deposit/withdraw fee, third party slippage applies for zaps. Your actual deposit is in styHONEY, not your starting token before zapping.) ",
		stableCoin: false,
		platform_alt: `${FarmOriginPlatform.Bearn.name} logo`,
		total_apy: 36.477,
		rewards_apy: 0,
		pair1: "styHONEY",
		token1: "0x99d6A0FB9420F3995fD07dCc36AC827a8E146cf9",
		zapper_addr: "0xAc75Dc484AbBa11685299dD397B32497b691c98A",
		alt1: "styHONEY logo",
		logo1: "https://raw.githubusercontent.com/BeraTrax/tokens/main/beratrax-tokens/yhoney/logo.png",
		rewards1: FarmOriginPlatform.Bearn.logo,
		rewards1_alt: `${FarmOriginPlatform.Bearn.name} logo`,
		isDeprecated: false,
		isUpgradable: false,
		isAutoCompounded: false,
		lp_address: "0x99d6A0FB9420F3995fD07dCc36AC827a8E146cf9", // Asset LP address
		decimals: 18,
		vault_addr: "0xe970001EFfF9f6Fd15e08dA3a5Ee2886A81291F5", // Vault address
		createdAt: 1747404574,
		zap_symbol: "HONEY",
		zap_currencies: [
			{
	...
	},
	{
		...
		secondary_platform_logo: FarmOriginPlatform.Kodiak.logo,
		source:
			"https://app.kodiak.finance/#/liquidity/pools/0x93a913351cae2d8c82c4b85f699726947eb76d32?farm=0x6b23e121c6a13c959d69493ea5ca015a5847596a&chain=berachain_mainnet",
		name1: "wBERA",
		name2: "RAMEN",
		description:
	...
	},
	{
		...
		secondary_platform_logo: FarmOriginPlatform.Kodiak.logo,
		source:
			"https://app.kodiak.finance/#/liquidity/pools/0x0fd67ac75f9df51f5d81f582417b318f44b45f5c?farm=0x193ff57dc9efa1dec154946c10332ba31c8e72b2&chain=berachain_mainnet",
		name1: "wBERA",
		name2: "BM",
		description:
	...
	},
	{
		...
		secondary_platform_logo: FarmOriginPlatform.Kodiak.logo,
		source:
			"https://app.kodiak.finance/#/liquidity/pools/0xef8c3239e0d8be9d58f145e18f5909ddad681365?farm=0x66eb42c499372e897929efbf6026821b0a148119&chain=berachain_mainnet",
		name1: "wBERA",
		name2: "NAV",
		description:
	...
	},
	{
		...
		secondary_platform_logo: FarmOriginPlatform.Kodiak.logo,
		source:
			"https://app.kodiak.finance/#/liquidity/pools/0x8b161685135e9fbc5475169e1addc0f2c4b7c343?farm=0xcf77d23cfc561e34e3b6137c736ea5cb395bcda0&chain=berachain_mainnet",
		name1: "wBERA",
		name2: "stBGT",
		description:
	...
	},
	{
		...
		platform: FarmOriginPlatform.Burrbear.name,
		platform_logo: FarmOriginPlatform.Burrbear.logo,
		synthetic: true,
		...
		stableCoin: false,
		platform_alt: `${FarmOriginPlatform.Burrbear.name} logo`,
		total_apy: 154.43,
		rewards_apy: 0,
		pair1: "wBERA",
		pair2: "wgBERA",
		...
		rewards1: FarmOriginPlatform.Burrbear.logo,
		rewards1_alt: `${FarmOriginPlatform.Burrbear.name} logo`,
		isDeprecated: false,
		isUpgradable: false,
		isAutoCompounded: true,
		isStablePool: true,
	...
	},
	{
		...
		url_name: "wBTC-SolvBTC-xSolvBTC",
		platform: "Burrbear",
		originPlatform: FarmOriginPlatform.Burrbear.name,
		source: "https://app.burrbear.io/#/berachain/pool/0xcbef1b65399065c2de2c495971e90466ff38f2d000000000000000000000001e",
		name1: "wBTC",
		name2: "SolvBTC",
		name3: "xSolvBTC",
		description:
			"This vault is built on Burrbear's wBTC-SolvBTC-xSolvBTC vault. Your deposit is automatically converted into the wBTC-SolvBTC-xSolvBTC LP and deposited for you. You'll earn WBERA, which is claimed and compounded once a minute. You can zap in using HONEY or BERA. Additionally, you'll accumulate BTX points for our future airdrop, and keep any airdrops to any of the underlying vaults. (Note: Although Trax does not have a deposit/withdraw fee, third party slippage applies for zaps. Your actual deposit is in wBTC-SolvBTC-xSolvBTC, not your starting token before zapping.) ",
		stableCoin: false,
		...
		token2: "0x541FD749419CA806a8bc7da8ac23D346f2dF8B77",
		token3: "0xCC0966D8418d412c599A6421b760a847eB169A8c",
		...
		logo1: "https://raw.githubusercontent.com/BeraTrax/tokens/main/beratrax-tokens/0x2577D24a26f8FA19c1058a8b0106E2c7303454a4/logo.png",
		logo2: "https://raw.githubusercontent.com/BeraTrax/tokens/main/beratrax-tokens/0x541FD749419CA806a8bc7da8ac23D346f2dF8B77/logo.png",
		logo3: "https://raw.githubusercontent.com/BeraTrax/tokens/main/beratrax-tokens/0xCC0966D8418d412c599A6421b760a847eB169A8c/logo.png",
	...
	},
	{
		...
		name2: "wgBERA",
		description:
			"This vault is built on Burrbear's Burr-wgBERA vault. Your deposit is automatically converted into the Burr-wgBERA LP and deposited for you. You'll earn WBERA, which is claimed and compounded once a minute. You can zap in using HONEY or BERA. Additionally, you'll accumulate BTX points for our future airdrop, and keep any airdrops to any of the underlying vaults. (Note: Although Trax does not have a deposit/withdraw fee, third party slippage applies for zaps. Your actual deposit is in Burr-wgBERA, not your starting token before zapping.) ",
		stableCoin: false,
		platform_alt: "Burrbear logo",
		total_apy: 36.477,
		rewards_apy: 0,
		...
		pair1: "Burr",
		pair2: "wgBERA",
		token1: "0x28e0e3B9817012b356119dF9e217c25932D609c2",
		token2: "0xD77552D3849ab4D8C3b189A9582d0ba4C1F4f912",
		zapper_addr: "0x2cD2f685b26A456041096DB63b7D3d35514d044E",
		alt1: "Burr logo",
		alt2: "wgBERA logo",
		logo1: "https://raw.githubusercontent.com/BeraTrax/tokens/main/beratrax-tokens/0x28e0e3B9817012b356119dF9e217c25932D609c2/logo.png",
		logo2: "https://raw.githubusercontent.com/BeraTrax/tokens/main/beratrax-tokens/0xd77552d3849ab4d8c3b189a9582d0ba4c1f4f912/logo.png",
		rewards1: "https://raw.githubusercontent.com/BeraTrax/tokens/main/logos/platform-logos/burrbear/burrbear.ico",
		rewards1_alt: "Burrbear logo",
		isDeprecated: false,
		...
		isAutoCompounded: true,
		isStablePool: true,
		lp_address: "0xAc8a437d1e6905E419431662AEAd90fB04ac3008",
		decimals: 18,
	...
	},
	{
		...
		name: "wBERA-HONEY",
		url_name: "wBERA-HONEY",
		platform: FarmOriginPlatform.Steer.name,
		originPlatform: FarmOriginPlatform.Steer.name,
		platform_logo: FarmOriginPlatform.Steer.logo,
		secondary_platform: FarmOriginPlatform.Wasabee.name,
		secondary_platform_logo: FarmOriginPlatform.Wasabee.logo,
		source: "https://app.steer.finance/vault/0xc3846436a0e321bcc63ab24731cd650044ace81c",
		name1: "wBERA",
		name2: "HONEY",
		description:
			"This vault is built on the wBERA-HONEY vault on Wasabee, which is rebalanced for a higher APY with Steer. Your deposit is automatically converted into the wBERA-HONEY LP and deposited for you. You can withdraw some or all of your position as BERA or HONEY at any time. Additionally, you'll accumulate BTX points for our future airdrop, and keep any airdrops to any of the underlying vaults. (Note: Although Trax does not have a deposit/withdraw fee, third-party slippage applies for zaps. Your actual deposit is in the LP, not your starting token before zapping.)",
		stableCoin: false,
		platform_alt: `${FarmOriginPlatform.Steer.name} logo`,
		total_apy: 14,
		rewards_apy: 0,
		pair1: "wBERA",
		pair2: "HONEY",
		...
		logo1: "https://raw.githubusercontent.com/BeraTrax/tokens/main/beratrax-tokens/0x7507c1dc16935B82698e4C63f2746A2fCf994dF8/logo.png",
		logo2: "https://raw.githubusercontent.com/BeraTrax/tokens/main/beratrax-tokens/0x0E4aaF1351de4c0264C5c7056Ef3777b41BD8e03/logo.png",
		rewards1: FarmOriginPlatform.Steer.logo,
		rewards1_alt: `${FarmOriginPlatform.Steer.name} logo`,
		isDeprecated: false,
		isUpgradable: false,
	...
	},
	{
		...
		originPlatform: FarmOriginPlatform.Kodiak.name,
		source:
			"https://app.kodiak.finance/#/liquidity/pools/0x4a254b11810b8ebb63c5468e438fc561cb1bb1da?farm=0x40c4d0a87157c3c1df26267ac02505d930baeeeb&chain=berachain_mainnet",
		name1: "wBERA",
		name2: "HONEY",
		description:
	...
	},
	{
		...
		originPlatform: FarmOriginPlatform.Kodiak.name,
		source:
			"https://app.kodiak.finance/#/liquidity/pools/0x9659dc8c1565e0bd82627267e3b4eed1a377ebe6?farm=0xf41ecc551e3c7449e74a7a7464bb2674fa76954c&chain=berachain_mainnet",
		name1: "wBERA",
		name2: "wETH",
		description:
	...
	},
	{
		...
		originPlatform: FarmOriginPlatform.Kodiak.name,
		source:
			"https://app.kodiak.finance/#/liquidity/pools/0xec8ba456b4e009408d0776cde8b91f8717d13fa1?farm=0x1c8e199c6c42d5cce652cf02002694d937118177&chain=berachain_mainnet",
		name1: "wBERA",
		name2: "YEET",
		description:
	...
	},
	{
		...
		originPlatform: FarmOriginPlatform.Kodiak.name,
		source:
			"https://app.kodiak.finance/#/liquidity/pools/0x93a913351cae2d8c82c4b85f699726947eb76d32?farm=0x6f22221dc5845a25597bc96629d92f2b4979d943&chain=berachain_mainnet",
		name1: "wBERA",
		name2: "RAMEN",
		description:
	...
	},
	{
		...
		originPlatform: FarmOriginPlatform.Kodiak.name,
		source:
			"https://app.kodiak.finance/#/liquidity/pools/0xf06ea29fcf4765200742d29e685973a1870eac98?farm=0x0d74359866a86d0f192f5cd53d103d299043165b&chain=berachain_mainnet",
		name1: "wBERA",
		name2: "wBTC",
		description:
	...
	},
	{
		...
		platform_logo: FarmOriginPlatform.Steer.logo,
		originPlatform: FarmOriginPlatform.Steer.name,
		secondary_platform: FarmOriginPlatform.Kodiak.name,
		secondary_platform_logo: FarmOriginPlatform.Kodiak.logo,
...
export const platformNames = pools_json.reduce(
	(acc, curr) => {
		if (curr.originPlatform && curr.platform_logo) {
			const exists = acc.some((item) => item.name === curr.originPlatform);
			if (!exists) {
				const count = pools_json.filter((item) => item.originPlatform === curr.originPlatform && !item.isDeprecated).length;
				acc.push({
...
export const tokenImages = pools_json.reduce(
	(acc, curr) => {
		if (curr.logo1) {
...
const getActivePoolIdsOfAllPlatforms = () => {
	const platformPools: Record<(typeof FarmOriginPlatform)[keyof typeof FarmOriginPlatform]["name"], number[]> = {
		[FarmOriginPlatform.BeraPaw.name]: [],
		[FarmOriginPlatform.Kodiak.name]: [],
		[FarmOriginPlatform.Steer.name]: [],
		[FarmOriginPlatform.Infrared.name]: [],
		[FarmOriginPlatform.Burrbear.name]: [],
		[FarmOriginPlatform.Gamma.name]: [],
		[FarmOriginPlatform.Core.name]: [],
		[FarmOriginPlatform.Arbera.name]: [],
		[FarmOriginPlatform.Beradrome.name]: [],
		[FarmOriginPlatform.Bearn.name]: [],
		[FarmOriginPlatform.Trax.name]: [],
		[FarmOriginPlatform.Hop.name]: [],
		[FarmOriginPlatform.Clipper.name]: [],
	...
	pools_json.forEach(({ id, originPlatform, secondary_platform, isUpcoming, isDeprecated }) => {
		...
		if (originPlatform === FarmOriginPlatform.BeraPaw.name && secondary_platform === undefined) {
			platformPools[FarmOriginPlatform.Kodiak.name].push(id);
		}
		if (FarmOriginPlatform.BeraPaw.name === originPlatform && secondary_platform === undefined) {
			platformPools[FarmOriginPlatform.BeraPaw.name].push(id);
		} else {
...
export const tokenNamesAndImages = pools_json.reduce(
	...
	},
	{
		[zeroAddress]: {
			name: "BERA",
			logos: ["https://raw.githubusercontent.com/BeraTrax/tokens/main/beratrax-tokens/0x7507c1dc16935B82698e4C63f2746A2fCf994dF8/logo.png"],
		},
