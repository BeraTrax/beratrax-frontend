			...
			<View className="flex justify-between gap-5 px-6 py-4 text-center">
				...
				<View className="flex justify-center flex-row items-center">
					<View className="flex mr-2">
						...
						{farm.logo2 ? <Image alt={farm.alt2} className={`w-11 h-11 md:w-14 md:h-14 ml-[-10px] rounded-full`} src={farm.logo2} /> : null}
						{farm.logo3 ? <Image alt={farm.alt3} className={`w-11 h-11 md:w-14 md:h-14 ml-[-10px] rounded-full`} src={farm.logo3} /> : null}
					</View>
				...
				<View className={`flex flex-col min-w-14 gap-1 mobile:min-w-full mobile:flex-row justify-center items-center sm:hidden`}>
					{isApyLoading ? (
						<Skeleton w={50} h={30} />
					) : (
						<View className={`flex flex-col min-w-14 gap-1 mobile:min-w-full mobile:flex-row justify-center items-center`}>
