...
const FarmApyGraph = ({ farm }: { farm: PoolDef }) => {
	...
	return (
		<div className={styles.apyContainer}>
			<h1 className={`${styles.apy_light} ${lightMode && styles.apy_dark}`} style={{ fontSize: "40px", fontWeight: "bold" }}>
				APY
			</h1>
				...
				{loading ? (
					...
					<>
						<ResponsiveContainer width="100%" height="100%">
							<AreaChart width={1200} height={250} data={newData} margin={{ top: 10, right: 30, left: -20, bottom: 0 }}>
								<defs>
