      ...
      {/* <h1 className={styles.mainHeading}>Intract Referral Contest! 🎉</h1>
            ...
            <section className={styles.paraSection}>
                <p className={styles.para}>
                    ...
                    share in 💵 $500 of USDC prizes! 💵 Not only that, you will get a copy of 10% of the BTX tokens
                    ...
                    <ol>
                        ...
                        <li>
                            Anyone who uses your link to sign up for the Beratrax for the first time will be counted as a
                            referral.
                        </li>
                    </ol>
                </p>
                ...
                <div className={`${styles.rulesSection} ${lightMode && styles.rulesSectionLight}`}>
                    <strong>📜 Rules</strong>
                    <ul>
                        <li>A referral only counts if the referred user also stakes in a Beratrax vault.</li>
                        ...
                        <li>
                            ...
                            <a href="https://beta.beratrax.finance/termsofuse.pdf">terms & conditions</a>.
                        </li>
                    </ul>
                </div>
                <div className={`${styles.rulesSection} ${lightMode && styles.rulesSectionLight}`}>
