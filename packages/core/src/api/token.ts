...
export const getTokenPricesBackend = async (timestamp: number | undefined = undefined, searchWidth: number | undefined = undefined) => {
	try {
...
export const getBalance = async (tokenAddress: Address, address: Address, client: Pick<IClients, "public">): Promise<bigint> => {
	try {
