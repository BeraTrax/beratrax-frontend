...
const CheckCircleIconContent = () => (
	<>
		...
		<Path stroke={Colors.gradientLight} strokeWidth={1.5} d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0" />
		<Path stroke={Colors.gradientLight} strokeWidth={1.5} d="M9 12l2 2l4 -4" />
	</>
);
