...
import { useNotification } from "src/state/notification/useNotification";
    ...
    return (
        ...
        >
            <div className="text-textWhite flex flex-col gap-4">
                ...
                <p className="text-textWhite mt-2 text-[16px] font-light leading-relaxed">
                        ...
                        <div className="bg-green-800/30 border border-green-600 rounded-md p-4 mt-2">
                            {success.map((notification, index) => (
                                <div key={index} className="mb-2 last:mb-0">
                                    {notification.title && (
                                        <p className="text-green-400 font-semibold mb-1">{notification.title}</p>
                                    )}
