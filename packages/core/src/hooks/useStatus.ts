...
import { fetchVaultStats } from "@beratrax/core/src/api/stats";
...
export const useStatus = () => {
	const {
		...
		// limit of 720 is due to the fact that our autocompound script runs every 8-10 minutes
		// and we want to get the latest 4 days of data
	...
	}, [autoCompoundData, refetchAutoCompoundStats, isRefetchingAutoCompoundStats, isLoadingAutoCompoundStats, autoCompoundStatsError]);
};
