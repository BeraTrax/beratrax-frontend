      ...
      case FarmSortOptions.Deposit_Low_to_High:
        data = data.sort((a, b) => {
          const aWithdrawableAmount =
            a.withdrawableAmounts && a.withdrawableAmounts[0] ? Number(a.withdrawableAmounts[0].amountDollar) : 0;
          const bWithdrawableAmount =
            b.withdrawableAmounts && b.withdrawableAmounts[0] ? Number(b.withdrawableAmounts[0].amountDollar) : 0;
