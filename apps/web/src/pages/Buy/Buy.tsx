		...
		<div className="flex flex-col items-center justify-center h-full">
			...
			<div className="w-full max-w-md p-6 bg-bgDark rounded-xl border border-gradientSecondary">
				<div className="flex justify-center mt-10">
					{address ? (
						<FundButton
							fundingUrl={`https://pay.coinbase.com/buy/select-asset?appId=${
								import.meta.env.REACT_APP_CDP_PROJECT_ID
							}&defaultAsset=USDC&defaultNetwork=berachain&addresses={"${address}":["berachain"]}&assets=["USDC"]`}
							openIn="tab"
						/>
					) : (
