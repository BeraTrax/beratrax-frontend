...
export const StatsCard: React.FC<Props> = ({ heading, value, icon, gradientClass, isLoading = false }) => {
    return (
        <div
            className={`relative overflow-hidden rounded-lg p-4 border border-borderDark ${
                gradientClass || "bg-bgSecondary"
            }`}
        >
