                    ...
                    <div className="grid grid-cols-2 gap-3 max-h-[300px] overflow-y-auto pr-2 custom-scrollbar">
                        ...
                        {vaults.map((vault, index) => (
                            <button
                                ...
                                onClick={() =>
                                    vault.rewardVault != userCurrentVote && setSelectedVault(vault.rewardVault)
                                }
                            >
                                <div className="flex items-center gap-3 mb-2">
                                    ...
                                    {userCurrentVote == vault.rewardVault && (
                                        <FaCircleCheck className="text-textPrimary" />
                                    )}
                                </div>
                                ...
                                <div className="space-y-1">
                                    ...
                                    <div className="flex justify-between text-sm">
                                        ...
                                        <span className="text-gradientPrimary">
                                            {Number(vault.apys.apy).toFixed(2)}%
                                        </span>
                                    </div>
                                </div>
