...
const VaultContracts: FC<VaultContractsProps> = ({ farm }) => {
	...
	return (
		<div className="mt-8">
			<h3 className="text-textWhite font-arame-mono font-normal text-[16px] leading-[18px] tracking-widest mb-4">VAULT CONTRACTS</h3>
			<div className="overflow-hidden rounded-xl bg-bgSecondary">
				<table className="w-full border-collapse">
					<tbody>
						{contracts.map((contract, index) => (
							<tr key={index} className={index !== contracts.length - 1 ? "border-b border-gray-700" : ""}>
