...
const pools_json: PoolDef[] = [
    ...
    },
    {
        ...
        name1: "LBGT",
        description:
            "This vault is built on BeraPaw's LBGT vault. Your deposit is automatically staked, and all rewards are claimed and auto-compounded every minute. You can deposit directly with LBGT or zap in using HONEY or BERA. Additionally, you'll accumulate BTX points for our future airdrop, and keep any airdrops to any of the underlying vaults. (Note: Although BeraTrax does not have a deposit/withdraw fee, third party slippage applies for zaps. Your actual deposit is in LBGT, not your starting token before zapping.) ",
        stableCoin: false,
        ...
        isUpgradable: false,
        isAutoCompounded: false,
        lp_address: "0xBaadCC2962417C01Af99fb2B7C75706B9bd6Babe", // Asset LP address
        decimals: 18,
        vault_addr: "0x716e9D67A7827a71e12F6b1BE66bbE03dC86762E", // Vault address
