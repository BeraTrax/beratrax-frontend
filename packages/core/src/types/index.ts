...
export interface UserTVL {
	...
	galxeRanking: number;
	referralRanking: number;
	referralCountWithNonZeroStake: number;
}
...
export interface IClients {
	wallet: ReturnType<typeof createWalletClient<CustomTransport | HttpTransport, Chain, JsonRpcAccount | LocalAccount, undefined>>;
	// wallet:
	//     | (
