...
const BurrBearAdmin: React.FC = () => {
    ...
    const isLocalOrStaging =
        window.location.hostname === "localhost" || window.location.hostname.includes("127.0.0.1") || isStagging;
    ...
    const handleInputChange = (vaultIndex: number, field: keyof APRValues, value: string) => {
        ...
        if (value === "" || /^(\d+)?\.?\d*$/.test(value)) {
            ...
            if (
                updatedVaults[vaultIndex].currentAprs![field] === "0" &&
                value !== "" &&
                value !== "0" &&
                value !== "0."
            ) {
                        ...
                        <form className="mt-6">
                            <div className="mb-4">
                                ...
                                <input
                                    ...
                                    onChange={(e: ChangeEvent<HTMLInputElement>) =>
                                        handleInputChange(index, "feeApr", e.target.value)
                                    }
                            ...
                            <div className="mb-4">
                                ...
                                <input
                                    ...
                                    onChange={(e: ChangeEvent<HTMLInputElement>) =>
                                        handleInputChange(index, "rewardsApr", e.target.value)
                                    }
                                    placeholder="e.g. 8.3"
                                    className="w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-textPrimary bg-bgSecondary text-white"
                                />
                            ...
                            <div className="mb-4">
                                ...
                                <input
                                    ...
                                    onChange={(e: ChangeEvent<HTMLInputElement>) =>
                                        handleInputChange(index, "pointsApr", e.target.value)
                                    }
