...
const pools_json: PoolDef[] = [
    ...
    },
    {
        ...
        source: "https://hub.berachain.com/pools/0x2c4a603a2aa5596287a06886862dc29d56dbc354000200000000000000000002/details/",
        name1: "wBERA",
        name2: "HONEY",
        description:
    ...
    },
    {
        ...
        originPlatform: FarmOriginPlatform.Infrared,
        secondary_platform: FarmOriginPlatform.Bex,
        source: "https://hub.berachain.com/pools/0x38fdd999fe8783037db1bbfe465759e312f2d809000200000000000000000004/details/",
        name1: "wBERA",
        name2: "wBTC",
        description:
    ...
    },
    {
        ...
        originPlatform: FarmOriginPlatform.Infrared,
        secondary_platform: FarmOriginPlatform.Bex,
        source: "https://hub.berachain.com/pools/0xdd70a5ef7d8cfe5c5134b5f9874b09fb5ce812b4000200000000000000000003/details/",
        name1: "wBERA",
        name2: "wETH",
        description:
    ...
    },
    {
        ...
        name3: "HONEY",
        description:
            "This vault is built on Infared's iBERA vault. Your deposit is automatically staked, and all rewards are claimed and auto-compounded every minute. You can deposit directly with iBGT or zap in using HONEY or BERA. Additionally, you'll accumulate BTX points for our future airdrop, and keep any airdrops to any of the underlying vaults. (Note: Although BeraTrax does not have a deposit/withdraw fee, third party slippage applies for zaps. Your actual deposit is in Nect-USDC-Honey, not your starting token before zapping.) ",
        stableCoin: false,
        platform: "Burrbear",
        ...
        token3: "0xac03CABA51e17c86c921E1f6CBFBdC91F8BB2E6b",
        zapper_addr: "0x1891c027B42C108D97EaBa80c910E86CD6c6A520",
        alt1: "Nect logo",
        alt2: "USDC logo",
        alt3: "HONEY logo",
    ...
    },
    {
        ...
        originPlatform: FarmOriginPlatform.Infrared,
        source: "https://hub.berachain.com/pools/0xde04c469ad658163e2a5e860a03a86b52f6fa8c8000000000000000000000000/details/",
        name1: "HONEY",
        name2: "BYUSD",
        description:
    ...
    },
    {
        ...
        url_name: "USDC-HONEY",
        originPlatform: FarmOriginPlatform.Infrared,
        source: "https://hub.berachain.com/pools/0xf961a8f6d8c69e7321e78d254ecafbcc3a637621000000000000000000000001/details/",
        name1: "USDC",
        name2: "HONEY",
        description:
